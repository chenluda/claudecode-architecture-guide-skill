...
| [pattern-catalog.md](references/pattern-catalog.md) | 15 transferable design patterns with code examples |
...
| [pattern-catalog.md](references/pattern-catalog.md) | 15 个可迁移设计模式及代码示例 |
